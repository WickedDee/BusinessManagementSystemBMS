<div class="modal fade" id="view_inventory_<?php echo $fetch['barcode']?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="inventory_modal_label" aria-hidden="true">
        ...
        <div class="row">
          ...
          <div class="row gx-3 pb-3">
            ...
            <div class="col-6">
                ...
                <input class="form-control" id="exp" name="exp" value="<?php echo $fetch['expiration']?>" readonly>
            </div>
          </div>
          <div class="row gx-3 pb-3">
            <div class="col-12">
          ...
          <div class="row gx-3 pb-3">
            ...
            <div class="col-3">
              ...
              <input class="form-control" id="qty" name="qty" value="<?php echo $fetch['quantity']?>" readonly>
            </div>
          </div>
          <div class="row gx-3 pb-3">
            <div class="col-6">
          ...
          <div class="modal-footer" >
            ...
            <button type="button" class="btn text-white" id="send_btn" name="update_inventory" data-bs-toggle="modal" data-bs-target="#update_inventory_<?php echo $fetch['barcode']?>" style="background-color:#859a41;">Update</button>
          </div>
        </div>
      </div>
    </div>
